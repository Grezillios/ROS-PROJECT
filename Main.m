...
% Last Modified by GUIDE v2.5 14-May-2016 01:43:21
...
img1 =  imread('turtlebot.png');
img2 =  imread('ros.png');
img3 =  imread('ROS_matlab.png');
img4 =  imread('ros_matlab1.jpg');
img5 =  imread('turtle.png');

axes(handles.axes1), imshow(img1)
axes(handles.axes2), imshow(img2)
axes(handles.axes3), imshow(img3)
axes(handles.axes4), imshow(img4)
axes(handles.axes5), imshow(img5)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
dai = inputdlg('Enter Password : ');
dai1 = cell2mat(dai);

reslt = strcmp(dai1, 'napelturbot');
if(reslt==1)
ros_matlab_bagga
else
